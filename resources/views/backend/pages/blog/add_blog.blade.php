                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo URL::current(); ?>">Blog Page</a></li>
                ...
                <div class="card">
                    ...
                    @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" id="tags" name="tags" value="tech,web" data-role="tagsinput">
                            </div>
                        </div>
                        <!-- end row -->
                         <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                               <img src="" style="width: 100px;, height=100px;" id="showImage">
                            </div>
                        </div>
                        <!-- end row -->
                        <!-- end row --> 

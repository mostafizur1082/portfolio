            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <input type="hidden" name="id" value="{{ $aboutpage->id }}">
                        ...
                        <!-- end row --> 
                        <div class="row mb-3">
                            <label for="short_des" class="col-sm-2 col-form-label">Short Description</label>
                            <div class="col-sm-10">
                                <textarea id="elm1" name="short_des">
                                   {{ $aboutpage->short_des }}
                                </textarea>
                            </div>
                        </div>
                        <!-- end row -->
                        <div class="row mb-3">
                            <label for="long_des" class="col-sm-2 col-form-label">Long Description</label>
                            <div class="col-sm-10">
                                <textarea id="elm2" name="long_des">
                                    {{ $aboutpage->long_des }}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                               <img class="rounded-circle" src="{{ (!empty($aboutpage->about_image))? url($aboutpage->about_image): url('upload/no_image.jpg') }}" style="width: 100px;, height=100px;" id="showImage">
                            </div>
                        </div>
                        <!-- end row -->
